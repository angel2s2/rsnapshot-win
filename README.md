...
Нашел утилиту [ln.exe](https://schinagl.priv.at/nt/ln/ln.html) от [Hermann Schinagl](https://schinagl.priv.at/), у которое есть режим DeLorean Copy, который по сути реализует то, что нужно.
